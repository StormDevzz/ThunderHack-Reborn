...
public class Strafe extends Module {
    ...
    private final Setting<Float> speed = new Setting<>("Speed", 1.0F, 0.1F, 10.0F);
    private final Setting<Float> setSpeed = new Setting<>("setSpeed", 1.3F, 0.0F, 2f, v -> boost.getValue() == Boost.Elytra);
