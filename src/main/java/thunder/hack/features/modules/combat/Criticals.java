...
public final class Criticals extends Module {
    ...
    private void critPacket(double yDelta, boolean full) {
        if (!full)
            ...
            sendPacket(new PlayerMoveC2SPacket.Full(mc.player.getX(), mc.player.getY() + yDelta, mc.player.getZ(), ((IClientPlayerEntity) mc.player).getLastYaw(), ((IClientPlayerEntity) mc.player).getLastPitch(), false, false));
    }
